...
class TestAdvancedIntegration:
    ...
    def test_multiple_agents_management(self):
        ...
        # Skip this test as it requires complex API integration and mocking
        pytest.skip("Skipping complex multi-agent management test - requires full API integration")
        agent_configs = [
            {
